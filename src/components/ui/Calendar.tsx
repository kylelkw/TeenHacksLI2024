export default function Calendar() {
    return (
        <div className="w-full bg-content-1 h-full rounded-3xl flex flex-col items-center relative blur-md z-0">
            <h1 className="text-display text-7xl text-bg font-medium mt-10">November 2024</h1>
